# settings.py gerado pelo Django
...
ROOT_URLCONF = 'minha_producao_diaria.urls'

# minha_producao_diaria/minha_producao_diaria/settings.py
...
TEMPLATES = [
    {
        ...
        # Altere esta linha para incluir o caminho da pasta 'registration'
...
WSGI_APPLICATION = 'minha_producao_diaria.wsgi.application'
...
# ... (todo o código existente do seu settings.py) ...
